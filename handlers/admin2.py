...
from data_base import sqlite_db2,sqlite_db,sqlite_db3
from keyboards import admin_kb,admin_kb2,admin_kb3
...
@dp.message_handler(commands='/Загрузить_Фруктовый',state=None)
...
async def delete_item(message: types.Message):
	if message.from_user.id == ID:
		read = await sqlite2_db.sql_read()
		for ret in read:
...
def register_handlers_admin(dp : Dispatcher):
	dp.register_message_handler(cm_start, commands=['/Загрузить_Фруктовый'], state=None)	
