...
def sql_start():
	...
	base.execute('CREATE TABLE IF NOT EXISTS venu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS fenu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS eenu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS renu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS aenu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS сenu(img TEXT, name TEXT PRIMARY KEY, description TEXT, price TEXT)')
	base.execute('CREATE TABLE IF NOT EXISTS henu(img TEXT,name TEXT PRIMARY KEY)')
	base.commit()
...
async def sql_add_command1(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO venu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command2(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO fenu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command3(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO eenu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command4(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO renu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command5(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO aenu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command6(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO cenu VALUES(?, ?, ?, ?)', tuple(data.values()))
		base.commit()
async def sql_add_command7(state):
	async with state.proxy() as data:
		cur.execute('INSERT INTO henu VALUES(?, ?)', tuple(data.values()))
		base.commit()
